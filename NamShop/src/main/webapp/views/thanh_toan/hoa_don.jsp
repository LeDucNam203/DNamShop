            ...
            <div class="row">
                ...
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <c:forEach var="item" items="${chiTietGioHang}">
                            <c:set var="totalPrice" value="${item.donGia * item.soLuong}" /> <!-- Tính tổng giá trị của từng sản phẩm -->
                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                <div>
                                    <h6 class="my-0">${item.id.chiTietSanPham.sanPham.ten}</h6>
